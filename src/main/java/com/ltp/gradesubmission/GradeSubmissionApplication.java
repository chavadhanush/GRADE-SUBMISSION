...
public class GradeSubmissionApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Student[] students = new Student[] {
				new Student("Ch.Dhanush", LocalDate.parse(("1980-07-31"))),
				new Student("Kohli", LocalDate.parse(("1980-03-01"))),
				new Student("Rohan", LocalDate.parse(("1979-09-19"))),
				new Student("Julie", LocalDate.parse(("1980-07-30")))
		};
